...
export const applyMiddleware = (dispatch) => (action) => {
  ...
  case types.LOGIN:
    return axios
    .post(`${API_URL}/auth/login`, action.payload)
    .then((res) =>
      dispatch({
      type: types.LOGIN,
      payload: res.data,
  ...
  case types.REGISTER:
    return axios
    .post(`${API_URL}/auth/register`, action.payload)
    .then((res) =>
      dispatch({
      type: types.REGISTER,
      payload: res.data,
  ...
  case types.TWEET:
    return axios
    .post(`${API_URL}/tweet/create`, action.payload, headers)
    .then((res) =>
      dispatch({
      type: types.TWEET,
      payload: res.data,
  ...
  case types.LIKE_TWEET:
    return axios
    .post(
      `${API_URL}/tweet/${action.payload.id}/like`,
      action.payload,
      headers,
    )
    .then((res) =>
  ...
  case types.BOOKMARK:
    return axios
    .post(
      `${API_URL}/tweet/${action.payload.id}/bookmark`,
      action.payload,
      headers,
    )
    .then((res) =>
  ...
  case types.GET_USER:
    return axios
    .get(`${API_URL}/user/${action.payload}/tweets`)
  ...
  case types.UPDATE_USER:
    return axios
    .put(`${API_URL}/user/i`, action.payload, headers)
    .then((res) =>
      dispatch({
  ...
  case types.RETWEET:
    return axios
    .post(
      `${API_URL}/tweet/${action.payload.id}/retweet`,
      action.payload,
      headers,
    )
    .then((res) =>
  ...
  case types.DELETE_TWEET:
    return axios
    .delete(`${API_URL}/tweet/${action.payload}/delete`, headers)
    .then((res) =>
      dispatch({
  ...
  case types.FOLLOW_USER:
    return axios
    .post(
      `${API_URL}/user/${action.payload}/follow`,
      action.payload,
      headers,
    )
    .then((res) =>
  ...
  case types.TREND_TWEETS:
    return axios
    .get(`${API_URL}/trend/${action.payload}`)
    .then((res) =>
      dispatch({ type: types.TREND_TWEETS, payload: res.data }),
    )
    .catch((err) =>
      dispatch({ type: types.ERROR, payload: err.response.data }),
    )
