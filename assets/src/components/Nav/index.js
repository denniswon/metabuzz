...
const Nav = ({ history }) => {
  ...
  <div className="Nav-component">
    ...
    <div className="Nav">
      ...
      <nav className="Nav-wrapper">
        ...
        <>
          ...
          <Link
          className="Nav-link"
          to={`/profile/${account && account.username}`}
          >
          <div
            className={
            path === '/prof'
        ...
        <div
          ...
          className="more-menu-background"
        >
        ...
        <div className="Nav-tweet">
          ...
          <div className="Nav-tweet-btn btn-hide">Tweet</div>
    ...
    >
      <div
      style={{ minHeight: '270px', height: 'initial' }}
